 ...
 * @author arch
 */
public class Mercaderia extends javax.swing.JDialog {

    /**
     * Creates new form Mercaderia
     */
    public Mercaderia(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Mercaderia dialog = new Mercaderia(new javax.swing.JFrame(), true);
